...
export default function Footer() {
  return (
    <footer className="relative z-40 border-t border-gray-200 dark:border-white/10 mt-24 transition-colors duration-300 bg-white/80 dark:bg-black/80 backdrop-blur-sm">
